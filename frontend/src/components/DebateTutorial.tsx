...
const tutorialSteps: Step[] = [
  {
    ...
    content: (
      <p style={{ fontSize: '0.875rem', color: '#374151', lineHeight: '1.6' }}>
        ...
        <span style={{ fontSize: '0.8125rem', color: '#6b7280' }}>다음 버튼을 클릭하면서 각 기능을 살펴보세요.</span>
      </p>
    ),
    skipBeacon: true,
  },
  {
    ...
    content: (
      <div style={{ fontSize: '0.875rem', color: '#374151', lineHeight: '1.6' }}>
        ...
        <p style={{ marginTop: '0.375rem', fontSize: '0.8125rem', color: '#6b7280' }}>
  ...
  },
  {
    ...
    content: (
      <div style={{ fontSize: '0.875rem', color: '#374151', lineHeight: '1.6' }}>
        ...
        <p style={{ marginTop: '0.5rem', fontSize: '0.75rem', color: '#6b7280' }}>2 라운드가 완료되면 토론을 계속 진행할지 선택할 수 있어요.</p>
      </div>
    ),
    skipBeacon: true,
    skipScroll: true,
      ...
      <div style={{ fontSize: '0.875rem', color: '#374151', lineHeight: '1.6' }}>
        <ul style={{ marginTop: '0.5rem', paddingLeft: '1rem', lineHeight: '1.6' }}>
          <li>
            ...
            <span style={{ display: 'block', paddingLeft: '1rem', marginTop: '0.25rem', fontSize: '0.8125rem', color: '#6b7280' }}>동일 주제로 토론을 처음부터 시작해요.</span>
          </li>
          <li style={{ marginTop: '0.5rem' }}>
            ...
            <span style={{ display: 'block', paddingLeft: '1rem', marginTop: '0.25rem', fontSize: '0.8125rem', color: '#6b7280' }}>현재 토론을 마치고 결과 보고서 화면으로 이동해요. 2라운드 전에 종료할 경우 결과가 나오지 않을 수 있습니다.</span>
          </li>
          <li style={{ marginTop: '0.5rem' }}>
            <span style={{ display: 'flex', alignItems: 'center', gap: '0.25rem', background: '#f3f4f6', color: '#111827', padding: '0.1875rem 0.5rem', borderRadius: '0.5rem', width: 'fit-content' }}><Maximize size={12} /><strong>전체 화면</strong></span>
            <span style={{ display: 'block', paddingLeft: '1rem', marginTop: '0.25rem', fontSize: '0.8125rem', color: '#6b7280' }}>화면을 넓게 펼쳐 토론에 더 집중할 수 있어요.</span>
          </li>
        </ul>
      </div>
    ),
  ...
  },
  {
    ...
    content: (
      <div style={{ fontSize: '0.875rem', color: '#374151', lineHeight: '1.6' }}>
        ...
        <ul style={{ marginTop: '0.3125rem', paddingLeft: '1rem', lineHeight: '1.9' }}>
        ...
        <div style={{ marginTop: '0.3125rem', padding: '0.625rem 0.75rem', background: 'color-mix(in srgb, var(--color-primary) 10%, transparent)', borderRadius: '0.5rem', fontSize: '0.8125rem' }}>
  ...
  },
  {
    ...
    content: (
      <div style={{ fontSize: '0.875rem', color: '#374151', lineHeight: '1.6' }}>
        ...
        <p style={{ marginTop: '0.5rem', fontSize: '0.75rem', color: '#6b7280' }}>팝업창 왼쪽 상단 모서리를 드래그하면 창 크기를 조절할 수 있어요.</p>
        <div style={{ marginTop: '0.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
          <div style={{ padding: '0.5rem 0.75rem', background: 'color-mix(in srgb, var(--color-primary) 10%, transparent)', borderRadius: '0.5rem', fontSize: '0.8125rem' }}>
            <p style={{ fontWeight: 'bold', color: 'var(--color-primary)', marginBottom: '0.25rem' }}>📢 단계별 발언 가이드</p>
            <p>주장·반박·재반박 단계가 바뀔 때마다 보조 에이전트가 자동으로 현재 단계에 맞는 발언 도움말을 알려줘요.</p>
          </div>
          <div style={{ padding: '0.5rem 0.75rem', background: 'color-mix(in srgb, var(--color-secondary) 10%, transparent)', borderRadius: '0.5rem', fontSize: '0.8125rem' }}>
            ...
            <p style={{ marginTop: '0.25rem', fontSize: '0.75rem', color: '#6b7280' }}>힌트는 참고용이에요. 이해한 내용을 내 말로 정리해보세요.</p>
          </div>
        </div>
  ...
  },
  {
    ...
    content: (
      <div style={{ fontSize: '0.875rem', color: '#374151', lineHeight: '1.6' }}>
        ...
        <p style={{ marginTop: '0.75rem', fontSize: '0.875rem', fontWeight: 'bold', color: 'var(--color-primary)' }}>
          그럼 토론을 시작해볼까요? 🚀
        </p>
      </div>
    ),
...
const CustomTooltip: React.FC<CustomTooltipProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* 제목 */}
      {step.title && (
        <div style={{ fontSize: '1rem', fontWeight: '800', color: '#111827', marginBottom: '0.625rem', paddingRight: '1.5rem' }}>
          {step.title}
        </div>
      )}
