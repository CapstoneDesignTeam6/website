      ...
      <div className="fixed bottom-0 inset-x-0 bg-white/90 backdrop-blur-xl border-t border-gray-100 py-4 md:py-6 px-4 md:px-8 z-50">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-3 md:gap-4 w-full md:w-auto">
            <button onClick={() => navigate('/setup')} className="flex-1 md:flex-none px-4 md:px-8 py-2.5 md:py-3 bg-gray-100 text-on-surface font-bold rounded-xl flex items-center justify-center gap-2 hover:bg-gray-200 transition-all text-xs md:text-sm">
